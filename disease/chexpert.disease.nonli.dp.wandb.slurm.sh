...
# run the program
python chexpert.disease.nonli.dp.wandb.py --config /vol/aimspace/users/ngq/Towards-Fair-and-Private-AI-in-Chest-Radiograph-Analysis/config/sweep_epsilon_1_maxvalrocauc_test_fast.yml