...
def main(hparams):
    ...
    out_name = f'batch_{batch_size}_epochs_{epochs}_{learning_rate}_resnet-{resnet_layer}'
    out_dir = 'chexpert_new/disease/' + out_name
    ...
    trainer = pl.Trainer(
        ...
        logger=TensorBoardLogger('chexpert_new/disease', name=out_name),
    )
