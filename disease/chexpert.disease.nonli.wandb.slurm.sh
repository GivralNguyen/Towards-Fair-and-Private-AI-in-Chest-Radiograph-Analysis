...
# run the program
python chexpert.disease.nonli.wandb.py --config /vol/aimspace/users/ngq/Towards-Fair-and-Private-AI-in-Chest-Radiograph-Analysis/config/sweep_non_private_maximize_val_AUC_minus_FPR.yml