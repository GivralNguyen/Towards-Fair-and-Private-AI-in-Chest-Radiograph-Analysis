...
# run the program
python chexpert.disease.nonli.dp.wandb.cook.py --config /vol/aimspace/users/ngq/Towards-Fair-and-Private-AI-in-Chest-Radiograph-Analysis/config/sweep_epsilon_7.48_maximize_all_val_AUC_minus_FPR_cook.yml